...
os.system('topojson -e city-names.csv -e Zip_MedianSoldPrice_AllHomes.csv -e Zip_PctOfHomesDecreasingInValues_AllHomes.csv -e Zip_HomesSoldAsForeclosures-Ratio_AllHomes.csv -p name=Name -p metro=Metro -p state=State --id-property=ZCTA5CE10,RegionName --simplify-proportion 0.15 -o ' + jsonFilename + ' ' + shpFilename)
